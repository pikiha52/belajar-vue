                    ...
                    <div>
                      <div class="flex items-center">
                        ...
                        <h1 class="
                            ...
                            leading-7
                            text-gray-900
                            sm:truncate sm:leading-9
                          ">
                          Good morning, <span class="capitalize">{{ fullname }}</span>
                        </h1>
                      </div>
                      <dl class="
                          mt-6
                        ...
                        <dd class="
                          ...
                          <svg class="mr-1.5 h-5 w-5 flex-shrink-0 text-green-400" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path fill-rule="evenodd"
